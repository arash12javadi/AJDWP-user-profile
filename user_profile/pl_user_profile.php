...
add_shortcode('pl_AJDWP_register_form', 'pl_AJDWP_registration_form');

// registration form fields
function pl_AJDWP_registration_form() {
    
    ob_start();
    include_once 'user_register_ajax.php';
    $user_register_data = ob_get_contents();
    ob_end_clean();

    ob_start();
    include_once 'forgot_password_ajax.php';
    ...
    ob_start();
    include_once 'delete_account_ajax.php';
